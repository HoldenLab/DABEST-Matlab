...
%   <a href="matlab:help('DabestViolin')">DabestViolin</a> objects.
%
...
% This code is released under the terms of the BSD 3-clause license
    ...
    % but also delete it from the arguments passed to DabestViolin
    grouporder = {};
    ...
    elseif not(hascategories) && isvector(data)
        violins = DabestViolin(data, 1,trueMedianDiff, varargin{:});
        set(gca, 'xtick', 1);
